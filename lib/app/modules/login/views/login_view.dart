          ...
          child: Container(
            ...
            child: ListView(
              children: [
                    ...
                    Expanded(
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10,),
                          Text("Log in",style: TextStyle(color: Colors.white,fontSize: 32,fontWeight: FontWeight.w700),),
                        ],
                      ),
                    ),
                ...
                Container(height:150,width:150,child: Image.asset("assets/images/whitelogo.png")),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Login",style: TextStyle(color: Colors.black,fontSize: 15),)),
                    width: 214,
                    height: 55,
                  ),
                ),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,children: [
                  ...
                  InkWell(onTap: (){
                    Get.toNamed("/signup");
                  },child: Text("Sign up",style: TextStyle(color: Theme.of(context).primaryColor,decoration: TextDecoration.underline,decorationColor: Theme.of(context).primaryColor,fontSize: 18),))
                ],)
